...
Datums: vandaag, morgen, overmorgen, maandag t/m zondag, volgende week, of YYYY-MM-DD
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="Datums: vandaag, morgen, overmorgen, maandag t/m zondag, volgende week, of YYYY-MM-DD",
    )
    parser.add_argument("titel", help="Naam/omschrijving van de taak")
    parser.add_argument("--due", "-d", default="", help="Deadline")
    parser.add_argument("--prio", "-p", default="normaal",
                        choices=["hoog", "normaal", "laag"],
